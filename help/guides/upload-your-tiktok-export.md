...
Choose **CSV** (not Excel) and save the **Content** file. It lists each video with its link, post time and views.

## Step 4

![Step 4](/help/screenshots/upload-your-tiktok-export-4.png)

In the dashboard, tap **Stats**, then **Upload TikTok export**, and pick that file.
